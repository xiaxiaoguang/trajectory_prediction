...
class TEASERrunner(nn.Module):
    def __init__(self,
        ...
        self.model_path = f"teaser_{w2v_window_size}_{teaser_num_ne}_{teaser_num_nn}_{teaser_beta}_{teaser_week_embed_size}_{embed_size}_{embed_epoch}_{dataset_name}.pth"
