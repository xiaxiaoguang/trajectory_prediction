...
python run.py --embed_name fourier --pre_model_name decoder --task_epoch 20 --embed_epoch 16 --device 0 --hidden_size 128
python run.py --embed_name fourier --pre_model_name decoder --task_epoch 50 --embed_epoch 100 --device 1 --hidden_size 128

python run.py --embed_name fourier --pre_model_name rnn --task_epoch 20 --embed_epoch 10 --device 0
